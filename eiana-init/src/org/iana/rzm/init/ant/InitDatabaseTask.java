...
//        domain.setState(Domain.State.NO_ACTIVITY);
    ...
    public void doExecute(Session session) throws MalformedURLException, NameServerAlreadyExistsException, InvalidIPAddressException {
        ...
        singleParam.setToDate(System.currentTimeMillis() + Parameter.DAY);
        session.save(singleParam);
        singleParam = new SingleParameter(AuthenticationService.USDOC_EMAIL, "usdoc@wrong.email.com.tv");
        singleParam.setOwner(Config.DEFAULT_OWNER);
        singleParam.setFromDate(System.currentTimeMillis());
        singleParam.setToDate(System.currentTimeMillis() + Parameter.DAY);
        session.save(singleParam);
        singleParam = new SingleParameter(AuthenticationService.USDOC_EMAIL_DOMAIN, "wrong.email.com.tv");
        singleParam.setOwner(Config.DEFAULT_OWNER);
        singleParam.setFromDate(System.currentTimeMillis());
        singleParam.setToDate(System.currentTimeMillis() + Parameter.DAY);
        session.save(singleParam);
        singleParam = new SingleParameter(AuthenticationService.USDOC_PUBLIC_KEY, "123afe32dc");
        singleParam.setOwner(Config.DEFAULT_OWNER);
        singleParam.setFromDate(System.currentTimeMillis());
        singleParam.setToDate(System.currentTimeMillis() + Parameter.DAY);
        session.save(singleParam);
        singleParam = new SingleParameter(AuthenticationService.VERISIGN_EMAIL, "verisign@wrong.email.com.tv");
        singleParam.setOwner(Config.DEFAULT_OWNER);
        singleParam.setFromDate(System.currentTimeMillis());
        singleParam.setToDate(System.currentTimeMillis() + Parameter.DAY);
        session.save(singleParam);
        singleParam = new SingleParameter(AuthenticationService.VERISIGN_PUBLIC_KEY, "321afe221dc");
        singleParam.setOwner(Config.DEFAULT_OWNER);
        singleParam.setFromDate(System.currentTimeMillis());
        singleParam.setToDate(System.currentTimeMillis() + Parameter.DAY);
        session.save(singleParam);
