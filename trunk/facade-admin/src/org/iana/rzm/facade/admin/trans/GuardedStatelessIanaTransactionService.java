 ...
 */
public class GuardedStatelessIanaTransactionService extends AbstractRZMStatelessService implements StatelessAdminTransactionService {

    private StatelessAdminTransactionService statelessAdminTransactionService;

    public GuardedStatelessIanaTransactionService(UserManager userManager, StatelessAdminTransactionService statelessAdminTransactionService) {
        super(userManager);
