...
public class TransactionNotificationProducer extends SingleNotificationProducer {
    ...
    public TransactionNotificationProducer(ContentFactory contentFactory, AddresseeProducer addresseeProducer, TemplateProducer templateProducer, DataProducer dataProducer) {
    ...
    protected Notification createNotification(Map<String, Object> dataSource) {
        ...
        return new Notification((Long) dataSource.get("transactionId"), td.getTicketID());
    }
}
