...
public class FromVOConverter {
    ...
    static {
        ...
        roleType.put(SystemRoleVO.SystemType.AC, Role.Type.AC);
        roleType.put(SystemRoleVO.SystemType.SO, Role.Type.SO);
        roleType.put(SystemRoleVO.SystemType.TC, Role.Type.TC);
    }
